        ...
        <div class="s">
            <div class="sidebar">
                ...
                <ul class="MenuSidebar">
                    ...
                    <li><i class="fas fa-building"></i> <a href="PoliceStation.php">Police Station</a></li>
                    <li><i class="fa-solid fa-users"></i><a href="TrafficPolice.php">Traffic Police</a></li>
                    ...
                    <li><i class="fa-sharp fa-solid fa-magnifying-glass"></i><a href="Search.php">Search Challan</a></li>
                </ul>
            </div>
        </div>
        <div class="h">
